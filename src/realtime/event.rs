...
impl serde::Serialize for EventNames {
        ...
        S: serde::Serializer,
    {
        ...
        match *self {
            AchievementEarned => serializer.serialize_unit_variant("EventNames", 0, "AchievementEarned"),
            ...
            PlayerFacilityCapture => serializer.serialize_unit_variant("EventNames", 8, "PlayerFacilityCapture"),
            PlayerFacilityDefend => serializer.serialize_unit_variant("EventNames", 9, "PlayerFacilityDefend"),
            ContinentLock => serializer.serialize_unit_variant("EventNames", 10, "ContinentLock"),
            ContinentUnlock => serializer.serialize_unit_variant("EventNames", 11, "ContinentUnlock"),
            FacilityControl => serializer.serialize_unit_variant("EventNames", 12, "FacilityControl"),
